...
api_id = 9266589
api_hash = "f78f09d45be03b07a498636ebb774d08"
bot = Client("CIO-self", api_id=api_id, api_hash=api_hash)
admin = 'me'
...
ورژن 2
صفحه دوم راهنما => <pre>راهنما 2</pre><pre>help2</pre>

                    """ , reply_to_message_id=message.id , parse_mode=enums.ParseMode.HTML)
        
    if message.text == "help2" or message.text == "راهنما 2":
        await bot.send_message(chat_id=message.chat.id , text="""
.
< راهنمای سلف صفحه 2 >
